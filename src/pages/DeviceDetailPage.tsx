    ...
    <div className="space-y-8">
      ...
      <div className="border-2 border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/70 rounded-2xl p-6 sm:p-7 backdrop-blur-md shadow-sm transition-colors">
        <div className="flex flex-col md:flex-row items-start justify-between gap-6">
          ...
          {/* Right Column: Gambar Mulai dari Posisi Judul (Sedikit Lebih Kecil & Fit) */}
          {device.image && (
            <div className="shrink-0 self-center md:self-start w-full sm:w-52 md:w-56 lg:w-60">
              <div
                onClick={() => setIsImageModalOpen(true)}
                className="group relative w-full h-36 sm:h-38 md:h-40 rounded-xl overflow-hidden border-2 border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 shadow-xs flex items-center justify-center p-2 cursor-pointer hover:border-blue-500/60 transition-all"
              ...
              >
                ...
                <div className="absolute inset-0 bg-slate-950/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-slate-900/80 text-white text-[11px] font-semibold backdrop-blur-xs shadow-sm">
                    <Maximize2 className="h-3 w-3" />
                    <span>Perbesar</span>
                  </span>
                </div>
                <span className="absolute bottom-1.5 right-1.5 px-2 py-0.5 rounded text-[9px] font-semibold bg-slate-900/75 text-white backdrop-blur-xs pointer-events-none">
                  Foto Perangkat
                </span>
              </div>
            </div>
